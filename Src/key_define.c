...
/* Variables ----------------------------------------------------------------*/
	...
	const KEY_DEFINE keytable[SCENE_COUNT][KEY_DEFINE_COUNT] = {
		{	//Scene0 Button (Library Tab)
			...
			{LED_COLOR_YELLOW,	LED_TIMER_DEFAULT,	"QuickCol"},	//L1M2	SW8
			{LED_COLOR_YELLOW,	LED_TIMER_DEFAULT,	"Undo    "},	//L1M3	SW9
			{LED_COLOR_YELLOW,	LED_TIMER_DEFAULT,	"Rate = 5"},	//L2M0	SW5
			{LED_COLOR_WHITE,	LED_TIMER_LONG,		"Scene  0"},	//L2M1	SW10 [SCENE]
			{LED_COLOR_WHITE,	LED_TIMER_DEFAULT,	"GridView"},	//L2M2	rot4 push
			{LED_COLOR_WHITE,	LED_TIMER_DEFAULT,	"PeopleVw"},	//L2M3	rot5 push
			...
			{LED_COLOR_BLUE,	LED_TIMER_HALF,		"Rate \x5  "},	//rot1 CW
			{LED_COLOR_BLUE,	LED_TIMER_HALF,		"Rate \x6  "},	//rot1 CCW
			{LED_COLOR_GREEN,	LED_TIMER_HALF,		"Flag \x5  "},	//rot2 CW
			{LED_COLOR_GREEN,	LED_TIMER_HALF,		"Flag \x6  "},	//rot2 CCW
			{LED_COLOR_YELLOW,	LED_TIMER_HALF,		"Rotate \x7"},	//rot3 CW
			{LED_COLOR_YELLOW,	LED_TIMER_HALF,		"Rotate \x8"},	//rot3 CCW
			{LED_COLOR_MAGENTA,	LED_TIMER_HALF,		"Scroll \x5"},	//rot4 CW
			{LED_COLOR_MAGENTA,	LED_TIMER_HALF,		"Scroll \x6"},	//rot4 CCW
			{LED_COLOR_ORANGE,	LED_TIMER_HALF,		"Zoom In "},	//rot5 CW
			{LED_COLOR_ORANGE,	LED_TIMER_HALF,		"Zoom Out"},	//rot5 CCW
		},{	//Scene1 Button
			...
			{LED_COLOR_YELLOW,	LED_TIMER_DEFAULT,	"Tangsten"},	//L0M3	SW4
			...
			{LED_COLOR_WHITE,	LED_TIMER_LONG,		"Scene  1"},	//L2M1	SW10 [SCENE]
			...
			//Scence1 Rotators
			{LED_COLOR_MAGENTA,	LED_TIMER_HALF	,	"Magenta "},	//rot0 CW
			{LED_COLOR_GREEN,	LED_TIMER_HALF,		"Green   "},	//rot0 CCW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"Shadows\x5"},	//rot1 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"Shadows\x6"},	//rot1 CCW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"Darks \x5 "},	//rot2 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"Darks \x6 "},	//rot2 CCW
			{LED_COLOR_GLAY,	LED_TIMER_HALF,		"Lights \x5"},	//rot3 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"Lights \x6"},	//rot3 CCW
			{LED_COLOR_WHITE,	LED_TIMER_HALF,		"HiLight\x5"},	//rot4 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"HiLight\x6"},	//rot4 CCW
			{LED_COLOR_YELLOW,	LED_TIMER_HALF,		"Temp.  \x5"},	//rot5 CW
			{LED_COLOR_BLUE,	LED_TIMER_HALF,		"Temp.  \x6"},	//rot5 CCW
		},{	//Scene2 Button
			...
			{LED_COLOR_RED,		LED_TIMER_LONG,		"Scene  2"},	//L2M1	SW10 [SCENE]
			...
			//Scence2 Rotators
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"Sat.Red\x5"},	//rot0 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"Sat.Red\x6"},	//rot0 CCW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatOrng\x5"},	//rot1 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatOrng\x6"},	//rot1 CCW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatYelw\x5"},	//rot2 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatYelw\x6"},	//rot2 CCW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatGren\x5"},	//rot3 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatGren\x6"},	//rot3 CCW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatCyan\x5"},	//rot4 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatCyan\x6"},	//rot4 CCW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatBlue\x5"},	//rot5 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatBlue\x6"},	//rot5 CCW
		},{	//Scene3 Button
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L0M0	SW1
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L0M1	SW2
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L0M2	SW3
			...
			{LED_COLOR_ORANGE,	LED_TIMER_LONG,		"Scene  3"},	//L2M1	SW10 [SCENE]
			...
			//Scence3 Rotators
			{LED_COLOR_BLUE,	LED_TIMER_HALF,		"Sharpen\x5"},	//rot0 CW
			{LED_COLOR_YELLOW,	LED_TIMER_HALF,		"Sharpen\x6"},	//rot0 CCW
			{LED_COLOR_CYAN,	LED_TIMER_HALF,		"#Radius\x5"},	//rot1 CW
			{LED_COLOR_MAGENTA,	LED_TIMER_HALF,		"#Radius\x6"},	//rot1 CCW
			{LED_COLOR_RED,		LED_TIMER_HALF,		"#Detail\x5"},	//rot2 CW
			{LED_COLOR_ORANGE,	LED_TIMER_HALF,		"#Detail\x6"},	//rot2 CCW
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//rot3 CW
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//rot3 CCW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"Sat.All\x5"},	//rot4 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"Sat.All\x6"},	//rot4 CCW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatMgnt\x5"},	//rot5 CW
			{LED_COLOR_OFF,		LED_TIMER_HALF,		"SatMgnt\x6"},	//rot5 CCW
		},
	};
#else //HID
	const uint8_t LED_Scene[SCENE_COUNT][LED_COUNT] ={
