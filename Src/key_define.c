...
//Switch definitions
    ...
    {HID_NONM,HID_u,	"Un-Flags"},//L1M0	SW6
    ...
    {HID_NONM,HID_NONE,	NULL},		//L3M0 rot1 push
    {HID_NONM,HID_NONE,	NULL},		//L3M1 rot2 push
    {HID_NONM,HID_NONE,	NULL},		//L3M2 rot3 push
    {HID_NONM,HID_x,	"Reject  "},//L3M3 rots push
//Rotator movements
    {HID_NONM,HID_NONE,NULL},	//rot1 CW
    {HID_NONM,HID_NONE,NULL},	//rot1 CCW
    {HID_NONM,HID_NONE,NULL},	//rot2 CW
    {HID_NONM,HID_NONE,NULL},	//rot2 CCW
    {HID_NONM,HID_NONE,NULL},	//rot3 CW
    {HID_NONM,HID_NONE,NULL},	//rot3 CCW
    {HID_NONM,HID_NONE,NULL},	//rot4 CW
    {HID_NONM,HID_NONE,NULL},	//rot4 CCW
    {HID_NONM,HID_NONE,NULL},	//rot5 CW
    {HID_NONM,HID_NONE,NULL},	//rot5 CCW
