...
/* Variables ----------------------------------------------------------------*/
	...
	const KEY_DEFINE keytable[SCENE_COUNT][KEY_DEFINE_COUNT] = {
		{	//Scene0 Button (Library Tab)
			...
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	"WB Auto."},	//L0M0	SW1
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	"AutoTone"},	//L0M1	SW2
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	"DayLight"},	//L0M2	SW3
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	"Tungsten"},	//L0M3	SW4
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	"Fluores."},	//L1M0	SW6
			...
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	"Clr.HiLt"},	//L2M2	rot4 push
			{LED_COLOR_WHITE,	LED_TIMER_DEFAULT,	"Clr.Temp"},	//L2M3	rot5 push
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L3M0	rot1 push
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	"Clr.Dark"},	//L3M1	rot2 push
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L3M2	rot3 push
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	"Clr. W/B"},	//L3M3	rot0 push
			//Scence1 Rotators
			...
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	"HiLight\x5"},	//rot4 CW
			...
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L1M3	SW9
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L2M0	SW5
			{LED_COLOR_WHITE,	LED_TIMER_DEFAULT*2,"Scene  2"},	//L2M1	SW10 [SCENE]
			...
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L1M3	SW9
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L2M0	SW5
			{LED_COLOR_WHITE,	LED_TIMER_DEFAULT*2,"Scene  3"},	//L2M1	SW10 [SCENE]
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L2M2	rot4 push
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L2M3	rot5 push
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L3M0	rot1 push
			{LED_COLOR_OFF,		LED_TIMER_DEFAULT,	NULL},			//L3M1	rot2 push
